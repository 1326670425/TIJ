/**
 * @Title RestaurantWithQueues.java
 * @Package ch21.restaurant2
 * @Description TODO
 * @author 吴扬颉
 * @date 2019年4月13日
 * @version 1.0
 ...
 * @Description 饭店仿真。引入了SynchronousQueue，这是一个没有内部容量的阻塞队列，每个put()必须等待take()。在这里表示设置在
 * 用餐者面前的某个位置，以加强在任何时刻只能上一道菜这个概念
 * @author 吴扬颉
 * @date 2019年4月13日
 * 
 */
